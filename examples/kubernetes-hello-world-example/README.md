...
Check out [test/kubernetes_hello_world_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.27.0/test/kubernetes_hello_world_example_test.go) to see how you can 
