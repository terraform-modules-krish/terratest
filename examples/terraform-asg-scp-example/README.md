...
Check out [test/terraform_scp_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.26.3/test/terraform_scp_example_test.go) to see how you can write
