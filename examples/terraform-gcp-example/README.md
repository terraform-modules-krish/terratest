...
Check out [test/terraform_gcp_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.13.5/test/terraform_gcp_example_test.go) to see how you can write
