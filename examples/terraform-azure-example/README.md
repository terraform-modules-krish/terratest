...
Check out [test/terraform_azure_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.25.1/test/terraform_azure_example_test.go) to see how you can write
