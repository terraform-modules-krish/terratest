...
[the example directory for this test](https://github.com/terraform-modules-krish/terratest/blob/v0.24.1/examples/terraform-ssh-password-example) will expect a default VPC to exist in
...
Check out [test/terraform_ssh_password_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.24.1/test/terraform_ssh_password_example_test.go) to see how you
...
[terraform-packer-example](https://github.com/terraform-modules-krish/terratest/blob/v0.24.1/examples/terraform-packer-example).
