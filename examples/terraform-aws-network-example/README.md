...
Check out [test/terraform_aws_network_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.27.3/test/terraform_aws_network_example_test.go) to see how you can write automated tests for this module and verify the basic parameters of the VPC and subnets.
