...
Check out [test/terraform_aws_dynamodb_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.27.5/test/terraform_aws_dynamodb_example_test.go) to see how you can 
