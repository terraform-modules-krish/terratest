...
Check out [test/terraform_aws_rds_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.14.0/test/terraform_aws_rds_example_test.go) to see how you can write
