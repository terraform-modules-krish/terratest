...
Check out [test/terraform_aws_rds_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.13.0/test/terraform_aws_rds_example_test.go) to see how you can write
