...
Check out [test/docker_hello_world_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.24.2/test/docker_hello_world_example_test.go) to see how you can write
