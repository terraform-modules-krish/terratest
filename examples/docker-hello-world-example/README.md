...
Check out [test/docker_hello_world_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.26.0/test/docker_hello_world_example_test.go) to see how you can write
