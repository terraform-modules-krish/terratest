...
Check out [test/terraform_aws_ssm_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.28.14/test/terraform_aws_ssm_test.go) to see how
