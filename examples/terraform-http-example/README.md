...
Check out [test/terraform_http_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.23.1/test/terraform_http_example_test.go) to see how you can write
