...
Check out [test/terraform_hello_world_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.28.12/test/terraform_hello_world_example_test.go) to see how you can 
...
[terraform-basic-example](https://github.com/terraform-modules-krish/terratest/blob/v0.28.12/examples/terraform-basic-example).
