...
Check out [test/terraform_hello_world_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.25.0/test/terraform_hello_world_example_test.go) to see how you can 
...
[terraform-basic-example](https://github.com/terraform-modules-krish/terratest/blob/v0.25.0/examples/terraform-basic-example).
