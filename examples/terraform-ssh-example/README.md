...
Check out [test/terraform_ssh_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.9.7/test/terraform_ssh_example_test.go) to see how you can write
