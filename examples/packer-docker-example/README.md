...
Check out [test/packer_docker_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.18.5/test/packer_docker_example_test.go) to see how you can write
...
See [terraform-packer-example](https://github.com/terraform-modules-krish/terratest/blob/v0.18.5/examples/terraform-packer-example).