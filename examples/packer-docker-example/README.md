...
Check out [test/packer_docker_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.18.6/test/packer_docker_example_test.go) to see how you can write
...
See [terraform-packer-example](https://github.com/terraform-modules-krish/terratest/blob/v0.18.6/examples/terraform-packer-example).