...
Check out [test/packer_docker_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.13.23/test/packer_docker_example_test.go) to see how you can write
...
[terraform-packer-example](https://github.com/terraform-modules-krish/terratest/blob/v0.13.23/examples/terraform-packer-example).
...
See [terraform-packer-example](https://github.com/terraform-modules-krish/terratest/blob/v0.13.23/examples/terraform-packer-example).