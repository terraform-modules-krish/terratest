...
Check out [test/packer_hello_world_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.28.0/test/packer_hello_world_example_test.go) to see how you can write
