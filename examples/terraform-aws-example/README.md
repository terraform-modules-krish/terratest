...
Check out [test/terraform_aws_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.17.6/test/terraform_aws_example_test.go) to see how you can write
