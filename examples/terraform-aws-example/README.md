...
Check out [test/terraform_aws_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.9.3/test/terraform_aws_example_test.go) to see how you can write
...
[terraform-http-example](https://github.com/terraform-modules-krish/terratest/blob/v0.9.3/examples/terraform-http-example) and [terraform-ssh-example](https://github.com/terraform-modules-krish/terratest/blob/v0.9.3/examples/terraform-ssh-example).
