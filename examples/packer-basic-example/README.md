...
Check out [test/packer_basic_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.17.5/test/packer_basic_example_test.go) to see how you can write
...
[packer-docker-example](https://github.com/terraform-modules-krish/terratest/blob/v0.17.5/examples/packer-docker-example) and
