...
Check out [test/terraform_basic_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.24.2/test/terraform_basic_example_test.go) to see how you can write
...
[terraform-aws-example](https://github.com/terraform-modules-krish/terratest/blob/v0.24.2/examples/terraform-aws-example).
