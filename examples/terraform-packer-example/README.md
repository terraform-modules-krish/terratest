...
[packer-docker-example](https://github.com/terraform-modules-krish/terratest/blob/v0.27.3/examples/packer-docker-example), which contains a simple Ruby web app. This module will
...
Check out [test/terraform_packer_example_test.go](https://github.com/terraform-modules-krish/terratest/blob/v0.27.3/test/terraform_packer_example_test.go) to see how you can write
...
1. Follow the instructions in [packer-docker-example](https://github.com/terraform-modules-krish/terratest/blob/v0.27.3/examples/packer-docker-example) to build an AMI. Note down the
   AMI ID.
