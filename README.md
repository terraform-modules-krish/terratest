...
1.  [Terraform remote-exec Example](https://github.com/terraform-modules-krish/terratest/blob/v0.18.6/examples/terraform-remote-exec-example): A terraform configuration that creates and
