...
As part of writing [Unit Tests with Terratest](https://github.com/terraform-modules-krish/terratest/blob/v0.18.3/README.md#unit-tests), we need a way to run our services in a Docker
