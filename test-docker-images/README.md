...
As part of writing [Unit Tests with Terratest](https://github.com/terraform-modules-krish/terratest/blob/v0.27.5/README.md#unit-tests), we recommend using [Packer](https://packer.io) to
