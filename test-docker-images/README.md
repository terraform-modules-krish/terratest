...
As part of writing [Unit Tests with Terratest](https://github.com/terraform-modules-krish/terratest/blob/v0.19.1/README.md#unit-tests), we recommend using [Packer](https://packer.io) to
