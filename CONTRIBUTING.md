...
functionality you're adding in your contribution. Check out the [test](https://github.com/terraform-modules-krish/terratest/blob/v0.11.0/test) folder for instructions on running the
automated tests.
